<template>
    <div class="bg-white rounded shadow-sm w-2/3 mt-6 overflow-hidden">
        ...
        <div class="w-full" v-if="post.data.attributes.image.length">
            <img class="w-full" :src="post.data.attributes.image" alt="image">
        </div>
        ...
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button
                ...
                class="focus:outline-none flex py-2 justify-center items-center rounded-lg text-sm w-full"
            ...
            <button
                ...
                class="flex py-2 justify-center items-center rounded-lg text-sm text-gray-700 w-full hover:bg-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-5 h-5">
                    <path
        ...
        >
            <div class="flex">
                <input type="text" v-model="commentBody" name="comment"
                       class="w-full pl-4 bg-gray-200 rounded-lg focus:outline-none"
