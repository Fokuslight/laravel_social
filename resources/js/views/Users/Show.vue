            ...
            <div class="w-100 h-64 overflow-hidden z-10">
                ...
                <div class="absolute flex items-center bottom-0 left-0 -mb-8 ml-12 z-20">
                    <div class="w-32">
                        ...
                        <UploadableImage
                            ...
                            image-height="750"
                            alt="avatar"
                            classes="w-32 object-cover h-32 border-4 border-gray-200 rounded-full shadow"
                ...
                <div class="absolute flex items-center bottom-0 right-0 mb-4 mr-12 z-20">
                    <button
                        ...
                        @click="$store.dispatch('sendFriendRequest',
                        $route.params.userId)"
                    >
                        {{ friendButtonText }}
                    </button>
                    <button
                        ...
                        @click="$store.dispatch('acceptFriendRequest',
                        $route.params.userId)"
                    >
                        Accept
                    </button>
